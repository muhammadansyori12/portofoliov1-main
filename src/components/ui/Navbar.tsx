...
export default function Navbar() {
  ...
  const smoothScrollTo = (
    ...
    const fallbackHref = targetId === '#home' ? '/' : `/${targetId}`
    if (!target) {
  ...
  return (
    <motion.nav
      ...
      style={{
        ...
        zIndex: 999, // Diperbesar agar tidak tertutup canvas 3D
        pointerEvents: 'auto', // Memastikan event klik tidak ditembus ke belakang
      }}
    >
      <div
        style={{
        ...
        {isMobile && (
          <div
            ...
            style={{
              ...
              gap: 4,
              cursor: 'pointer',
              padding: '10px', // Memperbesar area hitbox agar lebih mudah diklik di HP
            }}
          >
