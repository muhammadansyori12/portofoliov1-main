...
const skills = ["Arduino", "ESP32", "React"];
    ...
    >
      ...
      >
        ...
        <motion.div
          initial={false}
          animate={
            startAnim ? { opacity: 1, x: 0 } : { opacity: 0, x: 40 }
          }
        ...
        >
          ...
          >
            <TextType
              text={["IT Technician", "IoT Engineer", "Junior Frontend Developer"]}
              typingSpeed={75}
              pauseDuration={1500}
              showCursor
              cursorCharacter="_"
        ...
        >
          ...
          >
            IT Technician dan IoT Engineer dengan pengalaman mengelola hardware,
            software, dan jaringan. Mampu membangun sistem IoT, melakukan
            troubleshooting, serta membuat aplikasi web responsif dengan
            tampilan modern.
          </p>
        </motion.div>
